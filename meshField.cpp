...
#define FIELD_TEXU        (1.0f/(120))                                     // テクスチャ横分割数
#define FIELD_TEXV        (1.0f/(120))                                     // テクスチャ縦分割数
...
void CMeshField::Init()
{
	...
	m_PolygonNum = (int)((m_divide.y*(m_divide.x * 2)) + ((m_divide.y - 1) * 2) - 2);
	m_VexNum = (int)(m_divide.x * (m_divide.y + 1));
