...
//   モデル用シェーダの開始
//=======================================================================================
void CShaderGBuffer::Begin(const int pass)
{
...
//   頂点シェーダの情報を代入
//=======================================================================================
void CShaderGBuffer::SetVertexInfo( const D3DXMATRIX mtxW, const float contourScl )			// ワールド座標
{
	// カメラ情報取得
...
//   ピクセルシェーダの情報を代入
//=======================================================================================
void CShaderGBuffer::SetPixelInfo(const D3DCOLORVALUE diffColor,		// ディフューズカラー
