...
public:
	...
	CShadow(int numBlockX, int numBlockY,  float radius, D3DXVECTOR3 scl, D3DXCOLOR color, D3DXVECTOR3 pos);		// コンストラクタ
	~CShadow();					// デストラクタ

	// 生成処理
	static CShadow *Create(int numBlockX, int numBlockY, float radius, D3DXVECTOR3 scl);
	static CShadow *Create(int numBlockX, int numBlockY, float radius, D3DXVECTOR3 scl, D3DXVECTOR3 pos);
	static CShadow *Create(int numBlockX, int numBlockY, float radius, D3DXVECTOR3 scl, D3DXCOLOR color);
